...
const Hero: React.FC = () => {
  ...
  const appear = (delay: number) =>
    SSR
      ? {}
      : { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { type: 'spring' as const, bounce: 0, duration: 0.6, delay } }
  const appearSlow = SSR
    ? {}
    : { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { type: 'spring' as const, bounce: 0, duration: 0.8, delay: 0.2 } }
