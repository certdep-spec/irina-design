...
function About() {
  ...
  const workSteps = [
    ...
    },
    {
      step: '02',
      title: 'Планування',
      description: 'Створюємо зручне та функціональне планування без зайвих рішень.'
    },
    {
      step: '03',
      title: 'Візуалізація',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div>
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                <p>
                  Я спеціалізуюся на створенні комплексних рішень: від планування простору 
                  до розробки індивідуальних меблів. Це дозволяє зробити інтер’єр не лише красивим,
                  а й максимально зручним у використанні.
                </p>

                <p>
                  Маю досвід роботи з житловими просторами різного масштабу, 
                  співпрацювала з клієнтами в Україні та за кордоном.
                </p>

                <p>
                  Для мене дизайн — це не про картинку, а про комфорт у повсякденному житті. 
                  Я створюю інтер’єри, які легко реалізувати без зайвих витрат.
                </p>

                <p>
                  Працюю у Вінниці та по всій Україні дистанційно.
                </p>
              </div>
          ...
          <div className="mb-20">
            ...
            >
              {workSteps.map((item, index) => (
                <div key={index} className="relative p-6 bg-white border border-stone-200 rounded-sm hover:shadow-md transition-shadow">
