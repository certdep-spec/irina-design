      ...
      <Reveal as="section" className="bg-stone-100 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-stone-600 max-w-3xl mx-auto">
            Я Ірина, дизайнер інтер'єру з Вінниці. Допомагаю продумати квартиру, будинок або окреме приміщення до ремонту — від планування й меблів до візуалізацій та робочих креслень.
          </p>
        </div>
      </Reveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div>
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                ...
                <p>
                  Працюю з житловими й комерційними просторами, а також окремо проєктую кухні, шафи, гардеробні та інші корпусні меблі. Частину проєктів веду дистанційно.
                </p>
