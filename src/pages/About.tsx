          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div>
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                ...
                <p>
                  Маю досвід роботи з приміщеннями різного призначення та масштабу, 
                  співпрацювала з клієнтами в Україні та за кордоном.
                </p>

                <p>
                  Для мене дизайн — це комфорт, продуманість і гармонія у повсякденному житті. 
                  Я створюю інтер’єри, які поєднують естетику, функціональність і реалістичний підхід до реалізації.
                </p>

                <p>
                  Працюю у Вінниці та дистанційно.
                </p>
              </div>
