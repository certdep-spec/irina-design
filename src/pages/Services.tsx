...
function Services() {
  const services = [
    ...
    },
    {
      ...
      price: "від 800 грн/м²",
      features: [
        "3D-візуалізації приміщень, що входять до проєкту",
        "Комплект робочих креслень для реалізації проєкту",
        "Плани розеток, вимикачів, освітлення та сантехнічних точок",
